...
class Sampler(nn.Module):
    ...
    def forward(
        ...
        sample_results = _sample(probs, probs, sampling_metadata,
                                 sampling_tensors)
        # Get the logprobs query results.
        prompt_logprobs, sample_logprobs = _get_logprobs(
            probs, sampling_metadata, sample_results)

        with open('/home/zhiyuan/vllm_test/prompt_logits.json','w') as f: ## chagne to your customized path
            json.dump(prompt_logprobs,f)
        # pdb.set_trace()
    ...
    for i, (seq_group, sample_result) in enumerate(
        ...
        if (i < sampling_metadata.num_prompts
            ...
            for token_id in prompt_tokens[1:]:
                ...
                group_prompt_logprobs.append(logprobs[sample_idx][token_id].item())
                # # .append({
